...
#endif
extern "C" LaneMergeDll_API void SetUpRandom(double lamba_, int CaseLen_, int CaseNum_);
...
extern "C" LaneMergeDll_API int GetTimeOneAns(int LaneNum, int* TimeList);
extern "C" LaneMergeDll_API int GetTimeAns(int LaneNum, int* TimeList);
extern "C" LaneMergeDll_API int GetFinalTime();
extern "C" LaneMergeDll_API double GetTDelay();
